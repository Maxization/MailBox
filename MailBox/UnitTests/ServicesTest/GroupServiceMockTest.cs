...
namespace UnitTests.ServicesTest
{
    public class GroupServiceMockTest
    {
        ...
        private List<User> GetSampeUsers()
        {
            ...
            {
                new User { ID = 0, FirstName = "SenderName1", LastName = "SenderSurname1", Email = "sender1@address.com", GroupUsers = new List<GroupUser> { group0user1 } },
                new User { ID = 10, FirstName = "SenderName10", LastName = "SenderSurname10", Email = "sender10@address.com", GroupUsers = new List<GroupUser>() },
                new User { ID = 1, FirstName = "SenderName2", LastName = "SenderSurname2", Email = "sender2@address.com", GroupUsers = new List<GroupUser> { group0user1 } },
                new User { ID = 2, FirstName = "SenderName0", LastName = "SenderSurname0", Email = "sender0@address.com", GroupUsers = new List<GroupUser> { group0user2, group1user2, group2user2 } },
                new User { ID = 3, FirstName = "SenderName3", LastName = "SenderSurname3", Email = "sender3@address.com", GroupUsers = new List<GroupUser> { group2user3 } },
                new User { ID = 11, FirstName = "SenderName11", LastName = "SenderSurname11", Email = "sender11@address.com", GroupUsers = new List<GroupUser>() },
                new User { ID = 4, FirstName = "SenderName4", LastName = "SenderSurname4", Email = "sender4@address.com", GroupUsers = new List<GroupUser> { group1user4 } },
                new User { ID = 9, FirstName = "SenderName9", LastName = "SenderSurname9", Email = "sender9@address.com", GroupUsers = new List<GroupUser> { group2user9, group1user9 } }
            };
            return users;
        }
    }
